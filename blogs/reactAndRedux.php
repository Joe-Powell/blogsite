...
<div class="containBlog">
        ...
        you can grab values from any component within your React application. In React
         there is state and props but if you wanna pass state in through props, that component
        ...
        <ul>
            <h4>Here are the Foundumentals of Redux below</h4>
            ...
            <li><h4>Actions</h4>- Are functions your create that fire out the Dispatch information to the reducers. These Actions are in their own folder and get imported into 
